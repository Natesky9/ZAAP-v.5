...
for (i = 1;i <= 6;i += 1)
    ...
    /*
    //vertex left
    neighbor1 = hex_neighbor(get_grid,get_width,get_height,w,h,(i-1+6) mod 6 + 1)
    neighbor2 = hex_neighbor(get_grid,get_width,get_height,w,h,(i-2+6) mod 6 + 1)
    color = base_color
    ...
    */
    ...
    /*
    //vertex right
    neighbor1 = hex_neighbor(get_grid,get_width,get_height,w,h,(i-2+6) mod 6 + 1)
    neighbor2 = hex_neighbor(get_grid,get_width,get_height,w,h,(i-3+6) mod 6 + 1)
    color = base_color
