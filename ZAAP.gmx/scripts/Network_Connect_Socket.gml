...
ds_map_add(get_socket_map,"packets in",0)
ds_map_add(get_socket_map,"packet bytes in",0)
ds_map_add(get_socket_map,"packets out",0)
ds_map_add(get_socket_map,"packet bytes out",0)
